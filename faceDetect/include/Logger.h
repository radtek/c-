...
void main()
{
CLogger::Instance()->TraceFatal("TraceFatal %d", 1);
CLogger::Instance()->TraceError("TraceError %s", "sun");
CLogger::Instance()->TraceWarning("TraceWarning");
CLogger::Instance()->TraceInfo("TraceInfo");
CLogger::Instance()->.ChangeLogLevel(LOGGER::LogLevel_Error);
CLogger::Instance()->TraceFatal("TraceFatal %d", 2);
CLogger::Instance()->TraceError("TraceError %s", "sun2");
CLogger::Instance()->TraceWarning("TraceWarning");
CLogger::Instance()->TraceInfo("TraceInfo");
}
