========================================================================
    ACTIVEX 控件 DLL : Camera 项目概述
========================================================================

控件向导已为 Camera ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 Camera ActiveX 控件 DLL 的每个文件的内容。
...
CameraCtrl.h
    此文件包含 CCameraCtrl C++ 类的声明。

CameraCtrl.cpp
    此文件包含 CCameraCtrl C++ 类的实现。

CameraPropPage.h
    此文件包含 CCameraPropPage C++ 类的声明。

CameraPropPage.cpp
    此文件包含 CCameraPropPage C++ 类的实现。

CCameraCtrl.bmp
    此文件包含一个位图，当 CCameraCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 Camera.pch 的预编译头 (PCH) 文件和名为 
