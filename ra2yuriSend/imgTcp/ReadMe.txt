========================================================================
    ACTIVEX 控件 DLL : imgTcp 项目概述
========================================================================

控件向导已为 imgTcp ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 imgTcp ActiveX 控件 DLL 的每个文件的内容。
...
imgTcpCtrl.h
    此文件包含 CimgTcpCtrl C++ 类的声明。

imgTcpCtrl.cpp
    此文件包含 CimgTcpCtrl C++ 类的实现。

imgTcpPropPage.h
    此文件包含 CimgTcpPropPage C++ 类的声明。

imgTcpPropPage.cpp
    此文件包含 CimgTcpPropPage C++ 类的实现。

CimgTcpCtrl.bmp
    此文件包含一个位图，当 CimgTcpCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 imgTcp.pch 的预编译头 (PCH) 文件和名为 
