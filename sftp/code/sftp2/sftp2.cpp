...
BEGIN_MESSAGE_MAP(Csftp2App, CWinApp)
END_MESSAGE_MAP()
...
SHORT Csftp2App::SftpInit()
{
     ...
     */ 
	Csftp2App::session = libssh2_session_init();
...
//  远程创建路径
//=========================================================================
SHORT Csftp2App::CreatePath(string strRemotePath)
{
	SHORT sRet = 0;
...
//=========================================================================
void Csftp2App::UpdateInfo(string strIP, int nPort, string strAccount, string strPassword)
{
	// 获取ftp参数
...
//  上传文件
//=========================================================================
SHORT Csftp2App::SftpUploadFile(string strLocalFilePath, string strRemFilePath)
{
	FILE *local;
	size_t nread;
	int iRc;
...
//  文件改名
//=========================================================================
SHORT Csftp2App::SftpRename(string strOldRemoteFile,string strNewRemoteFile)
{
	SHORT sRet = 0;
	/*
	//退出释放资源
...
//  创建路径、上传文件、更改文件名
//=========================================================================
SHORT Csftp2App::CreateDirUploadRename(string strDirPathName,string strLocalFile, string strRemoteFile,string strOldRemoteFile,string strNewRemoteFile)
{
...
BOOL Csftp2App::SftpUploadFiles(CString strSftpIp, INT nSftpPort, CString strUser, CString strPassword, CString strSftpPath, CStringList &FilesList, CStringList &RenameFilesList)
{
